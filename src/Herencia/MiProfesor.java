package Herencia;
	...
	public class MiProfesor extends Persona {
		
		private String codProfesor, Departamento, Horario;
		private  Modulos listaModulos;
		
		public MiProfesor(String nombre, String dni, String telefono, String direccion, String codProfesor,
		    ...
		    //  Inicializamos y asignamos el array que recibimos por parámetro
		...
		public String toString() {
		    // Usamos el atributo de la clase (this.listaModulos) en lugar de modulo [] para crear uno nuevo
		...
		MiProfesor pr = (MiProfesor) obj;
		return this.dni.equals(pr.dni) && this.nombre.equals(pr.nombre) && this.listaModulos.equals(pr.listaModulos);
